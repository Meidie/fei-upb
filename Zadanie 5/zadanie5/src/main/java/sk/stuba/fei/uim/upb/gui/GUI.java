...
import sk.stuba.fei.uim.upb.io.Login;
...
public class GUI extends javax.swing.JFrame {
    ...
    public GUI() {
        ...
        java.net.URL helpURL = PasswordSecurityApp.class.getResource("/pages/uvod.html");
        if (helpURL != null) {
            try {
    ...
    private void loadUlohy(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loadUlohy
        java.net.URL helpURL = PasswordSecurityApp.class.getResource("/pages/ulohy.html");
        if (helpURL != null) {
            try {
                jEditorPane1.setPage(helpURL);
            } catch (IOException e) {
    ...
    private void loadSalt(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loadSalt
        java.net.URL helpURL = PasswordSecurityApp.class.getResource("/pages/salt.html");
        if (helpURL != null) {
            try {
                jEditorPane1.setPage(helpURL);
            } catch (IOException e) {
    ...
    private void loadDelay(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loadDelay
        java.net.URL helpURL = PasswordSecurityApp.class.getResource("/pages/delay.html");
        if (helpURL != null) {
            try {
                jEditorPane1.setPage(helpURL);
            } catch (IOException e) {
    ...
    private void loadHash(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loadHash
        java.net.URL helpURL = PasswordSecurityApp.class.getResource("/pages/hash.html");
        if (helpURL != null) {
            try {
                jEditorPane1.setPage(helpURL);
            } catch (IOException e) {
	...
	private void LogIn(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_LogIn
		...
		try {
			if (jTextField1.getText().equals("")) {
				...
				JOptionPane.showMessageDialog(rootPane, "Nevyplnene heslo.");
				jPasswordField2.setText(null);
			} else {
				MyResult result = login.signIn(jTextField1.getText(), String.valueOf(jPasswordField2.getPassword()));
				JOptionPane.showMessageDialog(rootPane, result.getMsg());
    ...
    public static void main(String args[]) {
        ...
        java.net.URL helpURL = PasswordSecurityApp.class.getResource(
                                        "pokus.html");
        if (helpURL != null) {
            try {
